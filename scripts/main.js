(() => {
  ...
  const contactFormRef = document.getElementById("contact-form");
  if (contactFormRef !== null) {
    ...
    (function() {
      emailjs.init("Yt3Dr_GT4blYkiIy8"); // Replace with your actual public key
    })();
    ...
    const formHandler = async (e) => {
      ...
      try {
        ...
        submitBtnRef.disabled = true;  // Disable button while sending
        ...
        const formData = {
          ...
          website: "amangupta.me",
        };

        // Send email using EmailJS
        const result = await emailjs.send(
          'service_9r9o87i', // Replace with your EmailJS service ID
          'template_ss8ztsb', // Replace with your EmailJS template ID
          formData
        );
        ...
        statusRef.innerHTML = "Failed to send message. Please try again!";
